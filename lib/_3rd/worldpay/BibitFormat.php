...
class BibitFormat {
	...
	public function CharacterData($parser, $result) {
		global $resultArray;
	...
	public function ParseXML($bibitResult) {
		$xml_parser = xml_parser_create();
		// set callback public functions
	...
	public function ReadXml($xml, $getElement, $attr = '', $type = 'string', $elementtype = 'tagName') {
		/**
 函数返回字符串.
 参数说明  : (1) $xml - xml文档 ,可以是字符串(4)$type='string' ,或者xml文件路径 (4)$type='filepath'
	...
	public function RedirectXykURL($ReplyArray, $yxkUrl) {
