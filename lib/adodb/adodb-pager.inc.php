...
class ADODB_Pager {
	...
	function Render_First($anchor=true)
	{
		...
		<?php
			...
			echo "<a href=\"" . $PHP_SELF . "?" . $this->id . "_next_page=1";
	...
	function render_next($anchor=true)
	{
		...
		{
			// edit by jayliaoscu @ 2007-7-26
			echo "<a href=\"".$PHP_SELF."?".$this->id."_next_page=".($this->rs->AbsolutePage() + 1);
	...
	function render_last($anchor=true)
	{
		...
		{
			// edit by jayliaoscu @ 2007-7-26
			echo "<a href=\"".$PHP_SELF."?".$this->id."_next_page=".$this->rs->LastPageNo();
	...
	// Added by LeoJay at 2005-9-22
	function SelectMenu()
	{
		global $PHP_SELF;
		
		$linksParameter	= $PHP_SELF ."?";
		if( !empty( $this->linksParameter ) ){
			$linksParameter .= $this->linksParameter;
		}
		$linksParameter	.= "&". $this->id ."_next_page='+this.value";
